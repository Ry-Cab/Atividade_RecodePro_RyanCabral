...
namespace AgenciaViagensMVC.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(DestinoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDestino,CidadeDestino,EstadoDestino,PaisDestino")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDestino,CidadeDestino,EstadoDestino,PaisDestino")] Destino destino)
        {
