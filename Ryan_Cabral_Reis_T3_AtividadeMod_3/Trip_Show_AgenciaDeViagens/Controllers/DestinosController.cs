...
namespace Destinos.Controllers
{
    public class DestinosController : Controller
    {
        ...
        public DestinosController(PassagemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID_DESTINO,CIDADE_DESTINO,ESTADO_DESTINO,PAIS_DESTINO,PRECO_DESTINO")] Destino destino)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID_DESTINO,CIDADE_DESTINO,ESTADO_DESTINO,PAIS_DESTINO,PRECO_DESTINO")] Destino destino)
        {
